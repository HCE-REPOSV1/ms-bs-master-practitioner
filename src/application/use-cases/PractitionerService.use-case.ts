...
export class PractitionerServiceUseCase {
  ...
  update(id: number, data: Partial<PractitionerService>): Promise<PractitionerService> {
    return this.repo.save({ ...data, practitioner_service_id: id } as PractitionerService);
  }
